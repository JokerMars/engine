...
FLT_PREOP_CALLBACK_STATUS
enginePreOperationNoPostOperation (
    _Inout_ PFLT_CALLBACK_DATA Data,
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _Flt_CompletionContext_Outptr_ PVOID *CompletionContext
    );
...
BOOLEAN
engineDoRequestOperationStatus(
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("engine!enginePreOperation: Entered\n") );
    ...
    if (engineDoRequestOperationStatus( Data )) {
        ...
        if (!NT_SUCCESS(status)) {
            ...
            PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                          ("engine!enginePreOperation: FltRequestOperationStatusCallback Failed, status=%08x\n",
                           status) );
        }
    }
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("engine!engineOperationStatusCallback: Entered\n") );

    PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                  ("engine!engineOperationStatusCallback: Status=%08x ctx=%p IrpMj=%02x.%02x \"%s\"\n",
                   OperationStatus,
                   RequesterContext,
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("engine!enginePostOperation: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("engine!enginePreOperationNoPostOperation: Entered\n") );
